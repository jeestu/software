...
<body>
    ...
    <table class="tablelist">
        ...
        <td>${clothes.name}</td>
        <td>${clothes.price}</td>
        <td><a href="${pageContext.request.contextPath}/clothes/delete.do?id=${clothes.id}" class="tablelink">删除</a>   
         <a href="${pageContext.request.contextPath}/clothes/toupdatecar?price=${clothes.price}"> 修改</a>  
        </tr>  
        </c:forEach>       
        </tbody>
    </table>
