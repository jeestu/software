...
<body>
    ...
    <table class="tablelist">
        ...
        <tbody>
        <c:forEach items="${dailyuseList}" var="dailyuse">
        <tr>
        <td><input name="" type="checkbox" value="" /></td>
        <td>${dailyuse.id}</td>
        <td>${dailyuse.name}</td>
        <td>${dailyuse.price}</td>
        <td><a href="${pageContext.request.contextPath}/dailyuse/delete.do?id=${dailyuse.id}" class="tablelink">删除</a>   
